...
public:
	...
	afx_msg void OnBnClickedButtonPwmwidthSet2();
	afx_msg void OnBnClickedCheckLight();
	CButton m_checkLight;
	afx_msg void OnBnClickedButtonPwmfreqSet();
	afx_msg void OnBnClickedButtonPwmwidthSet();
	afx_msg void OnBnClickedButtonAdcRd();
	int readAD(int ch);
};
